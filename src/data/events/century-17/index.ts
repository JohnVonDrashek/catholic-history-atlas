...
import edict_nantes_revocation from './edict-nantes-revocation.json';
import jansenism_rise from './jansenism-rise.json';
import north_american_martyrs from './north-american-martyrs.json';
