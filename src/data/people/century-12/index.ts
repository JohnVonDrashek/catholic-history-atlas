import adrian_iv from './adrian-iv.json';
import aelred_rievaulx from './aelred-rievaulx.json';
import alexander_iii from './alexander-iii.json';
...
import callistus_ii from './callistus-ii.json';
...
import hugh_saint_victor from './hugh-saint-victor.json';
import innocent_ii from './innocent-ii.json';
import ivo_chartres from './ivo-chartres.json';
import lucius_iii from './lucius-iii.json';
import nerses_the_gracious from './nerses-the-gracious.json';
